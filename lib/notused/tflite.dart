...
class _StaticImageState extends State<StaticImage> {
  ...
  List<Widget> renderBoxes(Size screen) {
    ...
    return _recognitions.map((re) {
      ...
      if ("${re["detectedClass"]}" == "omelette") {
        name = "crab";
      } else if ("${re["detectedClass"]}" == "wakame") {
        name = "omelette";
      }
       else if ("${re["detectedClass"]}" == "saba") {
        name = "wakame";
      }
      else if ("${re["detectedClass"]}" == "tuna") {
        name = "salmon";
      }
      else if ("${re["detectedClass"]}" == "eel") {
        name = "tuna";
      }
      else if ("${re["detectedClass"]}" == "crab") {
        name = "eel";
      }
       else if ("${re["detectedClass"]}" == "inari") {
        name = "squid";
      }
      else if ("${re["detectedClass"]}" == "temaki") {
        name = "inari";
      }
      else if ("${re["detectedClass"]}" == "inari") {
        name = "temaki";
      }
      else if ("${re["detectedClass"]}" == "salmon") {
        name = "temaki";
      }
      return Container(
        child: Positioned(
